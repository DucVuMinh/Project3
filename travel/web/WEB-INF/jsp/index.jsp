                    ...
                    <div class="row">
                            ...
                            <div class="avatar">
                                <div class= "thumbnai" >
                                    <div class="avatar-border">
                                        <img src="img/bilgate.jpg" class="home-avatar">
                                        <div class="figure">
                                            <a href="#" id="upload_link"><div class="text" style="margin-top:223px">
                                                    <i class="fa fa-camera-retro fa-lg"></i>  Thay avatar</div></a>
                                        </div> 
                                    </div>
                        ...
                        <div class="col-lg-9">
                            <div class="info-profile">
                                <div class="modal-body" ng-app="setuserinf" ng-controller="setuserinfctr">
