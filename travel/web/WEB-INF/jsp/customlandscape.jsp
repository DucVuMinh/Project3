<%-- 
    Document   : customlandscape
    Created on : 22-Nov-2016, 00:18:15
    Author     : DucVu
--%>
...
<html lang="en">
    ...
    <head>
        ...
        <script src="client/js/controller/appratingland.js"></script>
        <script src="client/js/controller/addlandfavor.js"></script>
    </head>
        ...
        <section id="about" class="container content-section text-center"  style="padding-top:190px;padding-bottom:30px">
            <div class="content">
                <div class="line-first">
                    ...
                    <div class="title">${infland.title}</div>
                        ...
                        <div class="comment" style="weight:700px">
                            ...
                            <div class="tab-content">
                                <div id="menu1" class="tab-pane fade">
                                    <div id="ratingele" ng-app="starApp" ng-controller="StarCtrl" ng-init="setRate(${infland.avgRank},${infland.rankOfUser},${infland.numberUserRank})"> 
                                        <div class=col-md-12>
    ...
    <script type="text/javascript">
        angular.element(document).ready(function () {
            angular.bootstrap(document.getElementById("ratingele"), ['starApp']);
