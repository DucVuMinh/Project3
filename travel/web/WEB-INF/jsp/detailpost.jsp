        ...
        <section id="sight" class="content-section ">
            <div class="download-section">
                <div class="container">
                    ...
                    <h2 class="text-center"><img src="img/default/baiviet.png">Bài Viết</h2>
                    <hr width="10px">
                    <div class="main-content" id="festival"> 
                        <c:forEach var="lland" items="${listPost}">
                            <div class="row" style="padding-bottom:40px">
                                <c:forEach var="land" items="${lland.listPost}">
                                    <div class="col-lg-6">
                                        <div class="row">
                                            <div class="col-lg-6">
                                            ...
                                            <div class="col-lg-6">
                                                ...
                                                <div class="hidden-letter ">${land.context}</div>
                                            </div>
                                        </div>
